...
/* re-initial code of boe otm9608a */
static struct sequence otm9608a_boe_lcd_init_table[] =
{
	//ff00h Command 2 enable: Read and write,only access when Orise mode enable
	//{0x00000,MIPI_DCS_COMMAND,200},
	{0x00000,MIPI_DCS_COMMAND,0},
	...
	{0x00008,TYPE_PARAMETER,0},
	// only into Orise Mode, the OTM9608 registers can be setted
	/* Move the MIPI option setting($B0B2)to the top of initial code */
	// b0b2h
	{0x00000,MIPI_DCS_COMMAND,0},
	...
	{0x00000,TYPE_PARAMETER,0},
	/* delete B392 configuration and add B391 configuration */
	//b391h
	{0x00000,MIPI_DCS_COMMAND,0},
	...
	{0x000b3,MIPI_GEN_COMMAND,0},
	{0x00019,TYPE_PARAMETER,0},
	{0x00010,TYPE_PARAMETER,0}, // Turn on SRAM power during sleep in mode
	...
	{0x000c0,MIPI_GEN_COMMAND,0},
	{0x00000,TYPE_PARAMETER,0},
	{0x00050,TYPE_PARAMETER,0},  // column inversion
	...
	{0x00081,TYPE_PARAMETER,0},
	{0x000C1,MIPI_GEN_COMMAND,0},
	{0x00066,TYPE_PARAMETER,0},  // 55 --> 66, 60fps
	...
	{0x000c5,MIPI_GEN_COMMAND,0},
	{0x00004,TYPE_PARAMETER,0},
	/* increase gram's voltage from 1.55v to 1.7v */
	{0x0000c,TYPE_PARAMETER,0},  // f8 --> 0c
	...
	{0x00003,TYPE_PARAMETER,0},
	/*change pwm frequency to 45kHZ for workaround backlight issue */
	{0x00002,TYPE_PARAMETER,0},  // 10 --> 02
	{0x00000,TYPE_PARAMETER,0},
	{0x0005f,TYPE_PARAMETER,0},  // 1f --> 5f
	{0x00012,TYPE_PARAMETER,0},
	...
	// d900h: VCOM voltage setting, no need to set
	...
	{0x00011,MIPI_DCS_COMMAND,0},   //Sleep out
	{0x00029,MIPI_DCS_COMMAND,120}, //Display on

	{0x00051,MIPI_DCS_COMMAND,20}, // displaybright
	{0x0007F,TYPE_PARAMETER,0},

	{0x00053,MIPI_DCS_COMMAND,5}, // ctrldisplay1
	{0x00024,TYPE_PARAMETER,0},

	{0x00055,MIPI_DCS_COMMAND,5}, // ctrldisplay2
	{0x00001,TYPE_PARAMETER,0},
...
static int mipi_otm9608a_qhd_lcd_on(struct platform_device *pdev)
{
	...
	if (!mfd->is_panel_alive)
	{
		...
		else if (MIPI_CMD_OTM9608A_BOE_QHD == lcd_panel_qhd)
		{
			process_mipi_table(mfd,&otm9608a_tx_buf,(struct sequence*)&otm9608a_boe_lcd_init_table,
				ARRAY_SIZE(otm9608a_boe_lcd_init_table), lcd_panel_qhd);
		}
		else
		{
			/* do nothing */
...
static int __init mipi_cmd_otm9608a_qhd_init(void)
{
	...
	if ( (MIPI_CMD_OTM9608A_TIANMA_QHD != lcd_panel_qhd)
		&& (MIPI_CMD_OTM9608A_BOE_QHD != lcd_panel_qhd) )
	{
		return 0;
	}
