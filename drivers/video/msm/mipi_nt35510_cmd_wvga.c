...
int mipi_nt35510_set_dynamic_gamma(enum danymic_gamma_mode  gamma_mode,struct msm_fb_data_type *mfd)
{
	...
	switch(gamma_mode)
	{
		case GAMMA25:
			...
			{
				process_mipi_table(mfd,&nt35510_tx_buf,(struct sequence*)&nt35510_boe_gamma_25,
						ARRAY_SIZE(nt35510_boe_gamma_25), lcd_panel_wvga);
			}
			else
			{
				process_mipi_table(mfd,&nt35510_tx_buf,(struct sequence*)&nt35510_cmi_gamma_25,
						ARRAY_SIZE(nt35510_cmi_gamma_25), lcd_panel_wvga);
			}
			break;
		case GAMMA22:
			if(MIPI_CMD_NT35510_BOE_WVGA == lcd_panel_wvga)
			{
				process_mipi_table(mfd,&nt35510_tx_buf,(struct sequence*)&nt35510_boe_gamma_22,
						ARRAY_SIZE(nt35510_boe_gamma_22), lcd_panel_wvga);
			}
			else
			{
				process_mipi_table(mfd,&nt35510_tx_buf,(struct sequence*)&nt35510_cmi_gamma_22,
						ARRAY_SIZE(nt35510_cmi_gamma_22), lcd_panel_wvga);
			}
			break;
		default:
